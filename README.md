...
<body>
  <header>
    ...
    <p>Hi there! I'm a passionate Full-Stack Developer and AI Enthusiast.</p>
  </header>

  <section>
    <h2>🔧 Technologies & Tools</h2>
    <ul>
      <li><strong>Backend:</strong> Node.js, Laravel, FastAPI, Django</li>
      <li><strong>Mobile Development:</strong> React Native, Kotlin</li>
      <li><strong>AI & APIs:</strong> Machine Learning, RESTful APIs, Data Science</li>
    </ul>
  ...
  <section>
    <h2>📈 GitHub Stats</h2>
    <p>Here's a glimpse of my GitHub activity:</p>
    <ul>
      <li>⭐ Stars: 150+</li>
      <li>🍴 Forks: 50+</li>
      <li>📂 Repositories: 30+</li>
      <li>📅 Commits: 1000+</li>
    </ul>
  </section>
  ...
  <section>
    <h2>🌱 Current Focus</h2>
    <p>I'm currently delving into:</p>
    <ul>
      <li>Building scalable APIs with FastAPI</li>
      <li>Developing cross-platform mobile applications using React Native</li>
      <li>Exploring AI-driven solutions and machine learning models</li>
    </ul>
  </section>

  <footer>
    <p>Let's connect and collaborate!</p>
    <p><a href="https://github.com/your-github-username" style="color: white;">Visit My GitHub</a></p>
  </footer>
